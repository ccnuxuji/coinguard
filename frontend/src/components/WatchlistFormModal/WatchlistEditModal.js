...
import { thunkCreateWatchlists, thunkEditWatchlists, thunkGetWatchlists } from "../../store/watchlist";


function WatchlistEditModal({ watchlist }) {
    ...
    const handleEditList = (e) => {
        e.preventDefault();
        dispatch(thunkEditWatchlists({ id: watchlist.id, name }))
    ...
    return (
        <div className="create-list-title-wrapper">
            <div className="create-list-title">
                <div>Edit list (no more than 10 characters)</div>
            ...
            <div className="create-list-form-wrapper">
                <form className="create-list-form" onSubmit={handleEditList}>
